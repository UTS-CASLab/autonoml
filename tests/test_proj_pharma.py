...
if __name__ == '__main__':
    ...
    # Connect the AutonoMachine to the server.
    # Because the user provides preset field names, the storage will begin immediately.
    port = proj.ingest_stream(server_hostname, server_port_data, 
                              in_id_stream = "pharma", in_field_names = get_field_names())
    
    # Wait for the port to be connected and to start storing data before proceeding.
